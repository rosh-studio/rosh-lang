...
player = GameObject(275, 275, 40, 40, (0, 255, 0), 'rectangle')
try:
...
box1 = GameObject(375, 275, 40, 40, (0, 0, 255), 'rectangle')
box1.visible = False

goal1 = GameObject(475, 275, 44, 44, (255, 0, 0), 'circle')
goal1.visible = False

wall1 = GameObject(475, 325, 40, 40, (255, 255, 0), 'rectangle')
wall1.visible = False
...
while running:
    ...
    # Draw all objects (goal first so player/box appear on top)
    title.draw(screen)
    subtitle.draw(screen)
    instructions.draw(screen)
    start_text.draw(screen)
    goal1.draw(screen)  # Draw goal first (background)
    wall1.draw(screen)
    box1.draw(screen)
    player.draw(screen)  # Draw player last (foreground)
