...
class ThreeJSEmitter(BaseEmitter):
    ...
    def _emit_fuzzy_matching(self):
        ...
        self.write("const KNOWN_COMMANDS = ['set', 'get', 'list', 'create', 'delete', 'clone', 'look', 'examine', 'inspect', 'help', 'prompt', 'save', 'load', 'capabilities', 'camera', 'undo', 'redo'];")
        self.write_blank()
    ...
    def _emit_exec_command(self):
        ...
        self.indent()
        self.write("log('Commands: list, get, set, look/examine, create, delete, clone, prompt, save, load, undo, undo stack, redo, redo stack, camera reset, capabilities', 'cyan');")
        self.dedent()
        self.write("}")
        ...
        self.write("const parentGroup = scene;")
        self.write("pushUndo('create ' + mesh.name, () => { parentGroup.remove(mesh); }, () => { parentGroup.add(mesh); });")
